...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Configurações de usuário" Type="Folder"/>
		...
		<Item Name="Support VIs" Type="Folder">
			<Property Name="NI.SortType" Type="Int">3</Property>
			<Item Name="Img Capture" Type="Folder">
				<Item Name="Img Capture.vi" Type="VI" URL="../support/Img Capture/Img Capture.vi"/>
			</Item>
			<Item Name="Log" Type="Folder">
				<Item Name="Concatenar atualização de configurações para Log.vi" Type="VI" URL="../support/Log/Concatenar atualização de configurações para Log.vi"/>
				<Item Name="Escrever Log.vi" Type="VI" URL="../support/Escrever Log.vi"/>
			</Item>
			<Item Name="Type Definitions" Type="Folder">
				<Item Name="Estados da configuração de usuário.ctl" Type="VI" URL="../support/Type Defs/Estados da configuração de usuário.ctl"/>
				<Item Name="UI Data.ctl" Type="VI" URL="../controls/UI Data.ctl"/>
			</Item>
			<Item Name="Usuários" Type="Folder">
				<Item Name="Configurações de Usuário.vi" Type="VI" URL="../support/Configurações de Usuário.vi"/>
				<Item Name="Criar nova lista de usuários.vi" Type="VI" URL="../support/INIs/Criar nova lista de usuários.vi"/>
			</Item>
			<Item Name="Configurações.lvlib" Type="Library" URL="../support/Configurações/Bibliotecas/Configurações.lvlib"/>
			<Item Name="User Event - Stop.lvlib" Type="Library" URL="../support/User Event - Stop/User Event - Stop.lvlib"/>
			<Item Name="Message Queue.lvlib" Type="Library" URL="../support/Message Queue/Message Queue.lvlib"/>
			<Item Name="Check Loop Error.vi" Type="VI" URL="../support/Check Loop Error.vi"/>
			<Item Name="Error Handler - Event Handling Loop.vi" Type="VI" URL="../support/Error Handler - Event Handling Loop.vi"/>
			<Item Name="Error Handler - Message Handling Loop.vi" Type="VI" URL="../support/Error Handler - Message Handling Loop.vi"/>
			<Item Name="Change Decoration Color.vi" Type="VI" URL="../support/Img Capture/Change Decoration Color.vi"/>
			<Item Name="Configurações.vi" Type="VI" URL="../support/Configurações.vi"/>
		</Item>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Ações de configuração 2.ctl" Type="VI" URL="../support/Configurações/Type Defs/Ações de configuração 2.ctl"/>
			<Item Name="Ações de configuração.ctl" Type="VI" URL="../support/Configurações/Type Defs/Ações de configuração.ctl"/>
