	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			...
			<Item Name="Configs" Type="Folder">
				<Item Name="Configurações.lvlib" Type="Library" URL="../support/Bibliotecas/Configurações.lvlib"/>
			</Item>
			<Item Name="Gatilho de Captura" Type="Folder">
				<Item Name="Gatilho de aquisição em linha.vi" Type="VI" URL="../support/Gatilho de aquisição em linha/Gatilho de aquisição em linha.vi"/>
			</Item>
